...
{
	if ((hash & 15) == 0) return (x + y);
	else if ((hash & 15) == 1) return (-x + y);
	else if ((hash & 15) == 2) return (x - y);
	else if ((hash & 15) == 3) return (-x - y);
	else if ((hash & 15) == 4) return (x + z);
	else if ((hash & 15) == 5) return (-x + z);
	else if ((hash & 15) == 6) return (x - z);
	else if ((hash & 15) == 7) return (-x - z);
	else if ((hash & 15) == 8) return (y + z);
	else if ((hash & 15) == 9) return (-y + z);
	else if ((hash & 15) == 10) return (y - z);
	else if ((hash & 15) == 11) return (-y - z);
	else if ((hash & 15) == 12) return (y + x);
	else if ((hash & 15) == 13) return (-y + z);
	else if ((hash & 15) == 14) return (y - x);
	else if ((hash & 15) == 15) return (-y - z);
	else return (0.0);
}
